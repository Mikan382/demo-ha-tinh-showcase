...
# --- SEASIDE: restore from source then targeted fix ---
SEASIDE_PAGES = ["index.html", "about.html", "resort.html", "rooms-overview.html", "contact.html"]

SEASIDE_TEXT = [
    ("Seaside - Webflow HTML website template", "Coastal Stay Ha Tinh — Lưu trú ven biển"),
    ("Modern looking responsive website template", "Website homestay và resort ven biển tại Hà Tĩnh"),
    ("Webflows CMS", "demo local"),
    (">Home<", ">Trang chủ<"),
    (">Homestay & Resort<", ">Giới thiệu<"),
    (">Resort<", ">Tiện ích<"),
    (">Events<", ">Trải nghiệm<"),
    (">Contact<", ">Liên hệ<"),
    ("Call us on", "Gọi"),
    ("Mail us at", "Email"),
    ("Visit us in", "Địa chỉ"),
    ("(+31)&nbsp;6 40 330 222", "0239 385 6789"),
    ("info@seasidehotel.com", "contact@coastalstay.demo"),
    ("Downside st. 43, 293X34, Peru", "Thiên Cầm, Hà Tĩnh"),
    ("Downside street 43", "Khu vực Thiên Cầm"),
    ("Peru", "Hà Tĩnh"),
    ("A gorgeous and relaxing pool next to your room", "Lưu trú gần biển, tận hưởng nhịp sống Hà Tĩnh"),
    ("Luxurious 2 person bedrooms", "Phòng view biển thoáng mát"),
    ("Large, modern Studios for rent", "Không gian nghỉ dưỡng hiện đại"),
    ("More about our accommodations", "Xem không gian lưu trú"),
    ("21 years experience", "Nhiều năm kinh nghiệm"),
    ("1 million visitors since 2014", "Hàng nghìn lượt khách mỗi năm"),
    ("Overall rating of 8.5", "Đánh giá 8.5/10"),
    ("10.000+&nbsp;positive reviews&nbsp;", "Hơn 1.000 đánh giá tích cực"),
    ("Enter your name", "Họ và tên"),
    ("Email address", "Email"),
    ("Phone number", "Số điện thoại"),
    ("Subscribe to updates", "Nhận tin mới"),
    ("Standard 2 persons suite", "Phòng đôi view biển"),
    ("Standard big family apartment", "Căn gia đình rộng rãi"),
    ("Romantic diner for 2 persons", "Bữa tối lãng mạn cho hai người"),
    ("Trip to the Mountains of Haiae", "Tour khám phá Hà Tĩnh"),
    ("Explore more", "Xem thêm"),
    ("Discover more", "Khám phá thêm"),
    ("View all", "Xem tất cả"),
    ("Book great adventures!", "Đặt trải nghiệm tại Hà Tĩnh"),
    ("Click<br>Here!", "Xem<br>ngay"),
    ("Our Hotel Restaurant", "Nhà hàng Coastal Stay"),
    ("Our Homestay & Resort Restaurant", "Nhà hàng ven biển"),
    ("The service of the staff is perfect", "Dịch vụ chu đáo, không gian đẹp"),
    ("It was a great pleasure to stay here", "Kỳ nghỉ tại Thiên Cầm rất đáng nhớ"),
    ("Samantha Brown", "Nguyễn Thu Hà"),
    ("David Johnson", "Trần Minh Anh"),
    ("Netherlands", "Hà Tĩnh"),
    ("United States", "Việt Nam"),
    ("Book now, pay later", "Đặt trước, thanh toán sau"),
    ("Feel safe&nbsp;and at ease", "An tâm khi lưu trú"),
    ("24/7 Helpdesk", "Hỗ trợ 24/7"),
    ("Our most <strong>popular</strong> destinations", "Điểm đến <strong>nổi bật</strong>"),
    ("Miami Beach", "Thiên Cầm"),
    ("Sicily", "Kẻ Gỗ"),
    ("South America", "Hương Tích"),
    ("Hamburg", "Đồng Lộc"),
    ("Munich", "Cảng cá"),
    ("Amsterdam", "Làng chài"),
    ("North America", "Ven biển"),
    ("Northern Euope", "Núi rừng"),
    ("Ulaanbaatar", "Hương Tích"),
    ("Warsaw", "Kẻ Gỗ"),
    ("Belgium", "Thiên Cầm"),
    ("East-Asia", "Miền Trung"),
    ("Contact us", "Liên hệ"),
    ("Liên hệ us", "Liên hệ"),
    ("Follow us", "Theo dõi"),
    ("Popular", "Phổ biến"),
    ...
    ("Information about us", "Giới thiệu resort"),
    ("Coastal Stay Homestay & Resort", "Coastal Stay Ha Tinh"),
    ("Sitemap", "Sơ đồ trang"),
    ("Last minutes", "Ưu đãi"),
    ("Copyright ©&nbsp;", "© 2026 "),
    ("Studio Corvus", ""),
    ("Powered by", ""),
    ("Homestay & Resort &amp;&nbsp;Resort", "Homestay & Resort"),
    ("Lorem ipsum", "Nội dung demo"),
    ("<title>About</title>", "<title>Giới thiệu</title>"),
    ("<title>Rooms overview</title>", "<title>Phòng nghỉ</title>"),
    ("Seaside - Webflow responsive template", "Coastal Stay Ha Tinh — resort ven biển"),
    ("Seaside -  responsive template", "Coastal Stay Ha Tinh"),
    (">Hotel<", ">Giới thiệu<"),
    (">Rooms<", ">Phòng<"),
    ("Rooms overview (List)", "Danh sách phòng"),
    ("Rooms overview (Columns)", "Phòng dạng cột"),
    ("About our hotel", "Giới thiệu Coastal Stay"),
    ("About our restaurant", "Nhà hàng ven biển"),
    ("Read more", "Xem thêm"),
    ("Useful links:", "Liên kết hữu ích:"),
    ("Customer reviews", "Đánh giá khách"),
    ("Day trips", "Tour trong ngày"),
    ("Events overview", "Trải nghiệm nổi bật"),
    ("We offer the widest range of guest rooms for you to choose from!", "Nhiều lựa chọn phòng nghỉ ven biển tại Hà Tĩnh"),
    ("The popular destinations for our returning visitors", "Điểm đến được khách yêu thích"),
    ("More about our Events", "Xem trải nghiệm"),
    ("London", "Đồng Lộc"),
    ("Thông tin about us", "Giới thiệu resort"),
    ("Seaside Hotel", "Coastal Stay Ha Tinh"),
    ("(+31)&nbsp;6 40 330 223", "0239 385 6789"),
    ("ideal for Hotels or other (room) renting services. Also great to showcase your upcoming events using demo local features.", "— homestay và resort ven biển tại Thiên Cầm."),
    ("<h1 class=\"logo-text\">Seaside</h1>", "<h1 class=\"logo-text\">Coastal Stay</h1>"),
    ("Hotel &amp;&nbsp;Resort", "Hà Tĩnh"),
    ("<title>Events</title>", "<title>Trải nghiệm</title>"),
    ("<title>Rooms</title>", "<title>Phòng nghỉ</title>"),
    ("<title>Rooms overview 2</title>", "<title>Phòng dạng cột</title>"),
    ("All you can eat sushi", "Buffet hải sản Thiên Cầm"),
    ("Large airy studio", "Studio rộng thoáng"),
    ("Luxury bridal suite", "Suite cao cấp"),
    ("Book this room", "Đặt phòng"),
    ("Amenities", "Tiện nghi"),
    ("Price per night", "Giá/đêm"),
    ("Our events", "Trải nghiệm nổi bật"),
    ("Upcoming events", "Sắp diễn ra"),
    ("Event details", "Chi tiết trải nghiệm"),
    ("The REsort", "Resort ven biển"),
    ("Our Luxury Tropical Resort with Pool.", "Resort nhiệt đới với hồ bơi tại Hà Tĩnh"),
    ("Our rooms", "Phòng nghỉ"),
    ("Standard rooms view in a list", "Danh sách phòng tiêu chuẩn"),
    ("A complete overview of our rooms", "Tổng quan phòng nghỉ ven biển"),
    ("Discover our", "Khám phá"),
    ("Large Airy Studio", "Studio rộng thoáng"),
    ("Luxury Bridal Suite", "Suite cao cấp"),
    ("€416 / Week", "2.500.000đ / tuần"),
    ("€416 / Weekend", "3.200.000đ / cuối tuần"),
    ("€416 / Midweek", "2.800.000đ / giữa tuần"),
    (">€416<", ">2.500.000đ<"),
    ("€416", "2.500.000đ"),
    ("Do you have questions, or need extra information?", "Bạn cần thêm thông tin? Hãy liên hệ chúng tôi"),
    ("Enter message...", "Nhập nội dung..."),
    ('placeholder="Location"', 'placeholder="Địa chỉ"'),
    ("Submit", "Gửi"),
    ("Thank you! Your submission has been received!", "Cảm ơn! Chúng tôi đã nhận tin nhắn."),
    ("Oops! Something went wrong while submitting the form.", "Có lỗi khi gửi form demo."),
    ("Oops! Something went wrong while submitting the form", "Có lỗi khi gửi form demo."),
    ("Please wait...", "Đang gửi..."),
    ("Hà Tĩnh.sp;", "Hà Tĩnh."),
    ('data-widget-latlng="-9.063336,-78.589011"', 'data-widget-latlng="18.2769,106.2540"'),
]

SEASIDE_EXTRA = [
    "events.html",
    "rooms-overview-columns.html",
    "rooms_standard-2-persons-suite.html",
    "rooms_standard-big-family-apartment.html",
    "rooms_luxury-bridal-suite.html",
    "rooms_large-airy-studio.html",
    "events_romantic-diner-for-2.html",
    "events_all-you-can-eat-sushi.html",
    "events_trip-to-the-mountains-of-haiae.html",
]

SEASIDE_BG = [
    ("5e342d16be45a694cc934d88_apartment-bed-bedroom-chair-271624.jpg", "09_hospitality_hospitality_sea_view_room.png"),
    ("5e342dc7be45a61507934fb9_brown-wooden-center-table-584399.jpg", "29_hospitality_luxury_sea_view_room.png"),
    ("5e342d8a91dfefe2247560c6_chair-cutlery-diner-dining-941861.jpg", "26_hospitality_beach_restaurant_sunset.png"),
    ("5e342d7b91dfef901775607b_person-on-a-bridge-near-a-lake-747964.jpg", "04_destination_destination_ke_go_lake.png"),
]

SEASIDE_CSS_FROM_CSS = "../../../../../assets/shared-images"
SEASIDE_CSS_HERO = [
    ("5e342cb86902d6ba5f4ac5bc_modern-styled-house-with-overviewing-swimming-pool-2034335.jpg", "08_hospitality_hospitality_beachfront_resort.png"),
    ("5e342cb5cb627f417538fad6_apartment-bed-bedroom-chair-271624.jpg", "35_hospitality_peaceful_beach_resort.png"),
    ("5e342cb943be9d24af53ca0a_brown-coffee-table-surrounded-by-four-chairs-635041.jpg", "48_hospitality_beach_resort_golden_hour.png"),
]


def apply_seaside_html(html: str, *, bg: bool = False) -> str:
    if 'lang="vi"' not in html[:500]:
        html = html.replace("<html", '<html lang="vi"', 1)
    html = html.replace("assets/cdn.prod.website-files.com/", "assets/assets.website-files.com/")
    for a, b in SEASIDE_TEXT:
        html = html.replace(a, b)
    if bg:
        for old, new in SEASIDE_BG:
            html = html.replace(old, new)
            for prefix in (
                "assets/cdn.prod.website-files.com/561acb7796da66bb2114da2c",
                "assets/assets.website-files.com/561acb7796da66bb2114da2c",
            ):
                html = html.replace(
                    f"url(&quot;{prefix}/{old}&quot;)",
                    f"url(&quot;{p(new)}&quot;)",
    ...
    html = re.sub(r"Lorem ipsum[^<]{0,200}", "Nội dung demo phù hợp resort ven biển Hà Tĩnh.", html)
    html = re.sub(
        r"Nội dung demo dolor sit amet[^<]{0,320}",
        "Nội dung demo phù hợp resort ven biển Hà Tĩnh.",
        html,
    )
    html = re.sub(
        r'src="assets/cdn\.prod\.website-files\.com/561acb7796da66bb2114da2c/(\d+_[^"]+\.png)"',
        r'src="../assets/shared-images/\1"',
        html,
    )
    if "shared-images" not in html:
        og = f'<meta property="og:image" content="{p("08_hospitality_hospitality_beachfront_resort.png")}">'
        if og not in html and "</head>" in html:
            html = html.replace("</head>", og + "</head>", 1)
    html = strip_vendor_links(html)
    return fix_forms(html)


def fix_seaside():
    dst = ROOT / "seaside-webflow"
    src = SRC / "seaside-webflow"
    for page in SEASIDE_PAGES:
        s, d = src / page, dst / page
        if s.exists():
            shutil.copy2(s, d)
    css = dst / "assets/assets.website-files.com/559ee37b3d3fed5c59f31670/css/template-seaside.webflow.ca9779723.css"
    if css.exists():
        c = css.read_text(encoding="utf-8")
        for old, new in SEASIDE_CSS_HERO:
            c = c.replace(
                f'url("../{old}")',
                f'url("{SEASIDE_CSS_FROM_CSS}/{new}")',
            )
        c = c.replace(
            'url("../../../d3e54v103j8qbb.cloudfront.net/img/example-bg.png")',
            f'url("{SEASIDE_CSS_FROM_CSS}/35_hospitality_peaceful_beach_resort.png")',
        )
    ...
    for page in SEASIDE_PAGES:
        ...
        if not fp.exists():
            continue
        html = apply_seaside_html(fp.read_text(encoding="utf-8"), bg=True)
        fp.write_text(html, encoding="utf-8")
    fix_seaside_extra()
    print("seaside restored + fixed")


def fix_seaside_extra():
    dst = ROOT / "seaside-webflow"
    room_imgs = [
    ...
    for page in SEASIDE_EXTRA:
        fp = dst / page
        if not fp.exists():
            continue
        html = apply_seaside_html(fp.read_text(encoding="utf-8"), bg=False)
        idx = 0

        def room_img(m):
            nonlocal idx
            src = m.group(1)
            if "Icon" in src or "icon" in src or "Favicon" in src:
                return m.group(0)
        ...
        html = re.sub(
            r'src="(assets/(?:assets\.website-files\.com|cdn\.prod\.website-files\.com)/[^"]+\.(?:jpg|jpeg|png))"',
            room_img,
            html,
        )
        fp.write_text(html, encoding="utf-8")
    print("seaside extra pages fixed")
