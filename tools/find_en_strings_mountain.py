...
en_words = [
    ...
    "design", "by", "powered", "colorlib", "react", "template", "lodge", "mountain", "explore",
    "discover", "stay", "accommodation", "accommodations", "activities", "reviews", "testimonials"
]
...
for fp in folder.glob("*.html"):
    ...
    for node in text_nodes:
        ...
        if is_vi:
            ...
            for word in ["read", "more", "us", "hotel", "room", "service", "event", "blog", "restaurant", "mountain", "lodge"]:
...
out_path = ROOT / "tools" / "en_strings_mountain.txt"
