...
MOONLIT_VI_EXTRA = [
    ...
    # Additional translations for moonlit-react template
    ("Moonlit - Hotel and Resturant", "Moonlit Hotel Ha Tinh — Khách sạn & Nhà hàng"),
    ("Assitant Manager", "Trợ lý Quản lý"),
    ("General Manager", "Tổng Quản lý"),
    ("Quality Inspector", "Kiểm định chất lượng"),
    ("Emma Elizabeth", "Lê Thị Hồng"),
    ("Jhon Doe", "Nguyễn Văn Nam"),
    ("Jhonathan Doe", "Nguyễn Văn Nam"),
    ("Jonathon Doe", "Nguyễn Văn Nam"),
    ("Alex Smith", "Trần Văn Minh"),
    ("Reactheme Solutions", "Khách du lịch"),
    ("Al Amin Khan", "Nguyễn Hoàng Nam"),
    ("Fortune It Solutions", "Bếp trưởng"),
    ("Alamin Hossen", "Lê Anh Tuấn"),
    ("Sr. Frontend", "Khách du lịch"),
    ("You need to enable JavaScript to run this app.", "Bạn cần kích hoạt JavaScript để chạy ứng dụng này."),
    (
        "Enjoy access to nearby slopes, perfect for both beginners and experienced skiers. Explore serene winter landscapes on guided snowshoe tours through nearby trails.",
        "Tận hưởng các hoạt động leo núi cát, dạo thuyền ven hồ Kẻ Gỗ và khám phá những rặng phi lao xanh mướt trải dọc bờ biển Thiên Cầm."
    ),
    ("Skiing & Snowboarding", "Leo núi & Dã ngoại"),
    ("Winter Wildlife Tours", "Khám phá thiên nhiên"),
    ("Hot Cocoa by the Fire", "Thưởng trà chiều bên hồ"),
    ("Guided Hiking Tours", "Tour leo núi cát"),
    ("Mountain Biking", "Đạp xe dạo hồ Kẻ Gỗ"),
    ("Outdoor Movie Nights", "Chiếu phim ngoài trời"),
    ("Tennis & Sports Courts", "Sân thể thao đa năng"),
    ("Cultural Tours", "Tour di tích lịch sử"),
    ("Read More", "Xem thêm"),
    ("View More", "Xem thêm"),
    ("Our Blog", "Blog của chúng tôi"),
    ("The Cozy Corner Suite", "Phòng Suite ấm cúng"),
    ("Spacious One-Bedroom in Prime Location", "Căn hộ 1 phòng ngủ rộng rãi"),
    ("Urban Chic Bedroom", "Phòng ngủ thanh lịch"),
    ("Comfortable Room with En-Suite Bathroom", "Phòng nghỉ tiện nghi có phòng tắm riêng"),
    ("Stylish City Homes", "Căn hộ phong cách"),
    ("Elegant Apartment with Private Terrace", "Căn hộ cao cấp có ban công riêng"),
    ("Wellness & Relaxation", "Thư giãn & Chăm sóc sức khỏe"),
    ("Top 10 Reasons Guests Love Staying at Moonlit", "10 lý do du khách yêu thích Moonlit"),
    ("Alpine Retreat", "Kỳ nghỉ dưỡng giữa đại ngàn"),
    ("Experience the Majesty of the Mountains", "Trải nghiệm vẻ đẹp kỳ vĩ của núi rừng"),
    ("Summit Suite", "Suite đỉnh đồi"),
    ("Nestled in Nature: Your Hotel Mountain Sanctuary", "Hòa mình cùng thiên nhiên: Không gian yên bình giữa núi rừng"),
    (
        "Whether you have questions, need assistance, or simply want to share.",
        "Dù bạn có thắc mắc, cần hỗ trợ hay chỉ muốn chia sẻ ý kiến."
    ),
    ("Love to hear from you Get in touch!", "Chúng tôi luôn lắng nghe — Hãy liên hệ ngay!"),
    ("Open Hours: Monday – Sunday", "Giờ mở cửa: Thứ Hai – Chủ Nhật"),
    ("Email: info@moonlit.com", "Email: contact@moonlit.demo"),
    ("We're Here to Help Reach Out to Us Today And Join Our Sự kiện", "Chúng tôi sẵn sàng hỗ trợ — Hãy liên hệ hôm nay để tham gia sự kiện"),
    ("Reservation By Email", "Đặt hẹn qua Email"),
    ("why choose our events", "Tại sao chọn sự kiện của chúng tôi"),
    ("Quality Room", "Phòng chất lượng cao"),
    (
        "where every image tells a story of luxury, comfort, and unparalleled hospitality",
        "Nơi mỗi bức ảnh kể về câu chuyện của sự sang trọng, tiện nghi và lòng hiếu khách"
    ),
    ("Discover Room", "Xem phòng"),
    ("Welcome To Our Moonlit Hotel & Resort", "Chào mừng đến Moonlit Hotel & Resort"),
    ("Our Rooms", "Phòng nghỉ của chúng tôi"),
    (
        ...
        "Trải nghiệm sự sang trọng và thư giãn tuyệt đối với ưu đãi độc quyền của chúng tôi! Đặt phòng ngay để nhận ưu đãi giảm 20% giá phòng tốt nhất."
    ),
    ("Daily family-friendly activities", "Hoạt động gia đình hàng ngày"),
    ("A two-night stay in a premium room", "Lưu trú 2 đêm tại phòng cao cấp"),
    ("25% off for stays of 7 nights or more", "Giảm 25% cho thời gian lưu trú từ 7 đêm trở lên"),
    ("Business Traveler Special", "Ưu đãi khách doanh nhân"),
    ("10% off on executive rooms", "Giảm 10% cho phòng executive"),
    ("Complimentary high-speed Wi-Fi", "Miễn phí Wi-Fi tốc độ cao"),
    ("Access to the business lounge", "Sử dụng phòng chờ thương gia"),
    ("Free airport shuttle service", "Dịch vụ đưa đón sân bay miễn phí"),
    ("A two-night stay in a deluxe suite", "Lưu trú 2 đêm tại suite sang trọng"),
    ("A bottle of champagne and chocolates", "Một chai rượu vang và sô-cô-la"),
    ("Romantic dinner for two", "Bữa tối lãng mạn dành cho 2 người"),
    ("Couples massage at our spa", "Massage đôi tại spa"),
    ("Our Gallery", "Thư viện ảnh của chúng tôi"),
    ("Hotel Room", "Phòng khách sạn"),
    ("Pool & Spa Center", "Trung tâm Hồ bơi & Spa"),
    ("Energy-Efficient Apartment with Smart Hotel", "Căn hộ hiện đại tiết kiệm năng lượng"),
    ("Our Apartment", "Căn hộ của chúng tôi"),
    ("Elegant Apartment", "Căn hộ thanh lịch"),
    ("Facility", "Tiện ích"),
    ("See Our Latest Blog", "Xem blog mới nhất"),
    ("Get In Touch", "Liên hệ với chúng tôi"),
    ("Submit Now", "Gửi ngay"),
    ("Elevate Your Stay Luxury and Adventure in the Mountains", "Nâng tầm kỳ nghỉ — Sang trọng và Khám phá giữa núi rừng"),
    ("Size: 35 sqm", "Diện tích: 35 m²"),
    ("Couple Package", "Gói đôi lứa"),
    ("Khách hàng nói gì About Us", "Khách hàng nói gì về chúng tôi"),
    ("Discover Luxury in the Heart of the City", "Khám phá sự sang trọng giữa lòng thành phố"),
    ("Best Offers", "Ưu đãi tốt nhất"),
    (
        ...
        "Thưởng thức sự kết hợp đầy màu sắc và dinh dưỡng từ các loại rau củ tươi ngon nhất theo mùa. Salad rau vườn gồm xà lách giòn, cà chua bi mọng nước, dưa chuột thanh mát."
    ),
    ("Velvet Red Reserve", "Vang đỏ hảo hạng"),
    ("Discover the Beauty of Our Coastal Haven", "Khám phá vẻ đẹp của thiên đường ven biển"),
    ("Coastal Elegance for Unforgettable Moments", "Sự thanh lịch ven biển cho những khoảnh khắc khó quên"),
    ("A Luxurious Retreat Comfort & Elegance Await", "Kỳ nghỉ dưỡng sang trọng — Tiện nghi & Thanh lịch đón chờ"),
    ("Elevate Your Experience Luxury, Comfort, and Elegance", "Nâng tầm trải nghiệm — Sang trọng, Tiện nghi và Thanh lịch"),
    ("The Restaurant", "Nhà hàng"),
    ("Hotel Experience", "Trải nghiệm khách sạn"),
    ("Reservation By Phone", "Đặt bàn qua điện thoại"),
    ("Opening Hours", "Giờ mở cửa"),
    ("Our Restaurant Gallery", "Thư viện ảnh nhà hàng"),
    ("Restaurant Menu", "Thực đơn nhà hàng"),
    ("Small Plates", "Món khai vị nhẹ"),
    ("Cold Appetizers", "Khai vị lạnh"),
    ("Vegetarian & Vegan", "Món chay"),
    ("Burgers & Sandwiches", "Burger & Sandwich"),
    ("Dips & Spreads", "Sốt & Bơ"),
    ("Seafood Specialties", "Đặc sản hải sản"),
    ("Tuscan Herb-Crusted Chicken", "Gà nướng thảo mộc kiểu Ý"),
    ("Salted caramel,Puff pastry,salad", "Caramel muối, bánh phồng, salad"),
    ("Classic Bolognese with Fresh", "Mỳ Ý sốt bò băm cổ điển"),
    (
        ...
        "Các phòng nghỉ và suite được bài trí trang nhã của chúng tôi được thiết kế để mang lại sự thoải mái và phong cách tối đa. Mỗi phòng đều có tiện nghi hiện đại, nội thất sang trọng và các chi tiết chu đáo để đảm bảo bạn có kỳ nghỉ thư thái."
    ),
    (
        ...
        "Hòa mình vào hành trình ẩm thực tại các nhà hàng của chúng tôi, nơi các đầu bếp tài hoa tạo nên những món ăn hấp dẫn từ nguyên liệu tươi ngon nhất của địa phương. Bắt đầu ngày mới với bữa sáng phong phú, thưởng thức bữa trưa thư thả và thưởng vị tối tinh tế trong không gian sang trọng."
    ),
    ("Room Amenities", "Tiện ích phòng"),
    ("Room Features", "Đặc điểm phòng"),
    ("Climate Control", "Điều hòa nhiệt độ"),
    ("Art and Decor", "Nghệ thuật & Trang trí"),
    ("Coffee/Tea Maker", "Máy pha trà/cà phê"),
    ("High-End Bedding", "Ga gối cao cấp"),
    ("Smart Technology", "Thiết bị thông minh"),
    ("Book Your Stay", "Đặt phòng ngay"),
    ("1 Room", "1 Phòng"),
    ("2 Room", "2 Phòng"),
    ("3 Room", "3 Phòng"),
    ("4 Room", "4 Phòng"),
    ...
    (
        "Also known as a Classic Room or Single Room, this is the most basic type of room, usually featuring essential amenities.",
        "Còn được gọi là Phòng Cổ điển hoặc Phòng Đơn, đây là loại phòng cơ bản nhất, trang bị đầy đủ các tiện nghi thiết yếu."
    ),
    ("always ready to tackle new challenges with and expertise. Their commitment to and delivering tailored.", "với dịch vụ chu đáo, phòng nghỉ tiện nghi và vị trí thuận lợi."),
    ("always ready to tackle new challenges with and expertise.Their commitment to and delivering tailored.", "với dịch vụ chu đáo, phòng nghỉ tiện nghi và vị trí thuận lợi."),
    ("Skiing &amp; Snowboarding", "Leo núi & Dã ngoại"),
    ("Skiing &amp;amp; Snowboarding", "Leo núi & Dã ngoại"),
    ("Tennis &amp; Sports Courts", "Sân thể thao"),
    ("Tennis &amp;amp; Sports Courts", "Sân thể thao"),
    ("Rooms &amp; Suites", "Phòng & Suite"),
    ("Rooms &amp;amp; Suites", "Phòng & Suite"),
    ...
    ("Dips &amp; Spreads", "Sốt & Bơ"),
    ("Dips &amp;amp; Spreads", "Sốt & Bơ"),
    ("Winter Hoạt động", "Hoạt động mùa đông"),
    ("Summer Hoạt động", "Hoạt động mùa hè"),
    ("Outdoor Hồ bơi", "Hồ bơi ngoài trời"),
    ("Snowshoeing", "Dạo bộ bãi cát"),
    ("Send Message", "Gửi tin nhắn"),
    ("Moonlit Team", "Đội ngũ Moonlit"),
    ("About US", "Giới thiệu"),
    ("About Us", "Giới thiệu"),
    ("About us", "Giới thiệu"),
    ("Pool &amp; Spa Center", "Trung tâm Hồ bơi & Spa"),
    ...
    ("Check In", "Nhận phòng"),
    ("Check Out", "Trả phòng"),
    ("Rooms and Suites", "Phòng & Suite"),
    ("Free Wifi", "Wi-Fi miễn phí"),
    ("Free Wi-Fi", "Wi-Fi miễn phí"),
    ("Work Desk", "Bàn làm việc"),
    ("Khám phá More", "Xem thêm"),
    ("Discover More", "Xem thêm"),
    ("A Luxurious Retreat Comfort &amp; Elegance Await", "Trải nghiệm lưu trú sang trọng tại Hà Tĩnh"),
    ("A Luxurious Retreat Comfort &amp;amp; Elegance Await", "Trải nghiệm lưu trú sang trọng tại Hà Tĩnh"),
    ("A Luxurious Retreat Comfort & Elegance Await", "Trải nghiệm lưu trú sang trọng tại Hà Tĩnh"),
    ("Welcome To Our Moonlit Hotel &amp; Resort", "Chào mừng đến Moonlit Hotel Ha Tinh"),
    ("Welcome To Our Moonlit Hotel &amp;amp; Resort", "Chào mừng đến Moonlit Hotel Ha Tinh"),
    ("Welcome To Our Moonlit Hotel & Resort", "Chào mừng đến Moonlit Hotel Ha Tinh"),
]
...
MOUNTAIN_VI = [
    ...
    # --- ADDITIONAL TRANSLATIONS FOR MOUNTAIN LODGE ---
    # Common, Hero & Decorative
    ("Boutique Hotel", "Khách sạn Boutique"),
    ("By the lake", "Bên hồ"),
    ("Established in 1990", "Thành lập từ năm 1990,"),
    ("Our boutique hotel offers a haven of sophistication and tranquility. Nestled amidst majestic peaks, our meticulously designed interiors reflect the timeless charm of the region. Experience unparalleled luxury and warm hospitality as you embark on an unforgettable journey amidst breathtaking natural beauty.", "Khu nghỉ dưỡng của chúng tôi mang đến một thiên đường tinh tế và yên bình. Nằm giữa thiên nhiên xanh mát, nội thất được thiết kế tỉ mỉ phản chiếu nét đẹp mộc mạc của vùng đất. Hãy trải nghiệm dịch vụ chu đáo và lòng hiếu khách ấm áp khi bắt đầu hành trình đáng nhớ giữa cảnh quan thiên nhiên kỳ vĩ."),
    ("Escape to tranquil luxury", "Nghỉ dưỡng yên bình giữa thiên nhiên"),
    ("&STYLE", "& PHONG CÁCH"),
    ("&HAPPENINGS", "& TRẢI NGHIỆM"),
    ("&SEIGHTS", "& CẢNH QUAN"),

    # Area
    ("Indulge in the Beauty", "Đắm chìm trong vẻ đẹp"),
    ("of our Region", "của vùng đất này"),
    ("Embarking on twilight strolls in the area reveals a symphony of nature's nocturnal melodies. Beneath the celestial canopy of the mountain sky, stars twinkle with mesmerizing clarity, casting ethereal light upon the landscape. Each step echoes amidst the tranquility, forging an unforgettable communion with the mountain's nocturnal majesty.", "Những buổi dạo bước hoàng hôn quanh hồ sẽ mở ra một bản giao hương âm thanh kỳ diệu của thiên nhiên. Dưới bầu trời đêm lấp lánh, ngàn vì sao tỏa sáng lung linh, chiếu rọi ánh sáng huyền ảo lên mặt nước. Mỗi bước chân hòa vào sự tĩnh lặng, tạo nên sự gắn kết khó quên với vẻ đẹp kỳ vĩ của núi rừng về đêm."),

    # Contact
    ("Reach out to us", "Liên hệ với chúng tôi"),
    ("ADDRESS", "ĐỊA CHỈ"),
    ("SOCIAL MEDIA", "MẠNG XÃ HỘI"),
    ("MESSAGE US", "GỬI TIN NHẮN"),

    # Restaurants & Events
    ("A Culinary Journey with Creative Dishes and Locally Farmed Produce", "Hành trình ẩm thực với những món ăn sáng tạo và nông sản địa phương"),
    ("Modern Italian cuisine", "Ẩm thực bản địa hiện đại"),
    ("TASTING MENU", "THỰC ĐƠN THỬ VỊ"),
    ("LUNCH MENU", "THỰC ĐƠN TRƯA"),
    ("A LA CARTE MENU", "THỰC ĐƠN GỌI MÓN"),
    ("Order a scenic picnic treat", "Đặt tiệc dã ngoại ngắm cảnh"),
    ("Want to indulge in the delightful experience of reserving a meticulously curated picnic to relish amidst our picturesque grounds? We boast a selection of charming locations, each exquisitely suited for an idyllic picnic affair.", "Bạn có muốn tận hưởng trải nghiệm thú vị khi đặt một buổi dã ngoại được chuẩn bị tỉ mỉ giữa khuôn viên thơ mộng của chúng tôi? Chúng tôi có sẵn nhiều địa điểm tuyệt đẹp, hoàn hảo cho một buổi dã ngoại yên bình."),
    ("Get in touch with us to book this lovely experience!", "Hãy liên hệ với chúng tôi để đặt trải nghiệm tuyệt vời này!"),
    ("LIÊN HỆ US", "LIÊN HỆ CHÚNG TÔI"),
    ("Cheese Tasting", "Nếm thử phô mai"),
    ("Mixology Class", "Lớp học pha chế"),
    ("Tea Ceremony", "Trà đạo"),
    ("Pizza Cooking Class", "Lớp học làm Pizza"),
    ("Local Cooking Class", "Lớp học nấu ăn địa phương"),
    ("Check what's on", "Lịch hoạt động & Sự kiện"),
    ("Cheese making class", "Lớp làm phô mai thủ công"),
    ("Pizza making class", "Lớp học làm bánh Pizza"),
    ("Fishing on the lake", "Câu cá trên hồ Kẻ Gỗ"),
    ("Baking session", "Lớp học làm bánh nướng"),

    # Rooms
    ("Let's find a nice room for you", "Tìm phòng nghỉ lý tưởng cho bạn"),
    ("Arrival date", "Ngày nhận phòng"),
    ("PROVIDED IN EVERY ROOM", "TRANG BỊ TRONG MỖI PHÒNG"),
    ("Complimentary high speed Wi-fi connection", "Kết nối Wi-Fi tốc độ cao miễn phí"),
    ("ROOM SERVICE", "DỊCH VỤ PHÒNG"),
    ("Delivery of our restaurant menu straight to the room", "Phục vụ thực đơn nhà hàng trực tiếp tại phòng"),
    ("High quality eco-friendly and hypoallergenic toiletries", "Sản phẩm vệ sinh cá nhân hữu cơ và thân thiện với môi trường"),
    ("COFFEE BAR", "QUẦY CÀ PHÊ"),
    ("Tea and coffee bar including minibar", "Quầy trà & cà phê bao gồm tủ lạnh mini"),
    ("STANDARD SINGLE ROOM", "PHÒNG TIÊU CHUẨN ĐƠN"),
    ("STANDARD DOUBLE ROOM", "PHÒNG TIÊU CHUẨN ĐÔI"),
    ("SIGNATURE SUITE", "PHÒNG SIGNATURE SUITE"),
    ("Standard Single Room", "Phòng tiêu chuẩn đơn"),
    ("Standard Double Room", "Phòng tiêu chuẩn đôi"),
    ("Signature Suite", "Phòng Signature Suite"),
    ...
    ("Workstation | High-definition television | Noise-cancelling windows | Climate control | Security box | Snack bar | Nespresso equipment | Tea pot | Landline | Complimentary internet", "Bàn làm việc | Tivi HD | Cửa cách âm | Điều hòa nhiệt độ | Két an toàn | Quầy ăn nhẹ | Máy pha cà phê Nespresso | Ấm pha trà | Điện thoại bàn | Internet miễn phí"),
    ("BATHROOM FACILITIES", "TIỆN NGHI PHÒNG TẮM"),
    ("Hairdryer | Towel radiator | Cosmetic mirror | ARELIA Skincare", "Máy sấy tóc | Giàn sấy khăn | Gương trang điểm | Mỹ phẩm dưỡng da cao cấp"),

    # Cooking Class Paragraph Correction (matching the partially-translated version in source)
    ("Embark on a culinary journey with our cooking class, focusing on wholesome ecological recipes inspired by the verdant valleys and alpine plateaus where fresh produce thrives in abundance. Khám phá the art of using locally sourced ingredients like fresh trout, succulent deer meat, and crisp mountain greens like Swiss chard and kale. Learn preservation techniques to retain the nutritional essence of these natural delicacies.", "Tham gia lớp học nấu ăn cùng đầu bếp địa phương — khám phá ẩm thực sinh thái từ nguyên liệu tươi xung quanh hồ Kẻ Gỗ như cá suối, rau rừng và các đặc sản vùng núi Hà Tĩnh."),

    # Licensing & Legal (Privacy Policy / Terms)
    ("images/videos", "hình ảnh/video"),
    ("Privacy Policy", "Chính sách bảo mật"),
    ("Welcome to Ke Go Eco Lodge! Your privacy is important to us. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, www.website.com. Please read this policy carefully. If you do not agree with the terms of this Privacy Policy, please do not access the site.", "Chào mừng bạn đến với Ke Go Eco Lodge! Quyền riêng tư của bạn rất quan trọng đối với chúng tôi. Chính sách bảo mật này giải thích cách chúng tôi thu thập, sử dụng, tiết lộ và bảo vệ thông tin của bạn khi bạn truy cập trang web www.website.com. Vui lòng đọc kỹ chính sách này. Nếu bạn không đồng ý với các điều khoản của Chính sách bảo mật này, vui lòng không truy cập trang web."),
    ("Information We Collect", "Thông tin chúng tôi thu thập"),
    ("We collect information about you in a variety of ways. The information we may collect on the site includes:", "Chúng tôi thu thập thông tin về bạn theo nhiều cách khác nhau. Thông tin chúng tôi có thể thu thập trên trang web bao gồm:"),
    ("Personal Data", "Dữ liệu cá nhân"),
    ("Personally identifiable information, such as your name, shipping address, email address, and telephone number, and demographic information, such as your age, gender, hometown, and interests, that you voluntarily give to us when you register with the site or when you choose to participate in various activities related to the site, such as online chat and message boards.", "Thông tin nhận dạng cá nhân, chẳng hạn như tên, địa chỉ, địa chỉ email và số điện thoại, và thông tin nhân khẩu học như tuổi, giới tính, quê quán và sở thích mà bạn tự nguyện cung cấp cho chúng tôi khi đăng ký trên trang web hoặc khi tham gia các hoạt động liên quan, như trò chuyện trực tuyến và diễn đàn."),
    ("Derivative Data", "Dữ liệu phát sinh"),
    ("Information our servers automatically collect when you access the site, such as your IP address, your browser type, your operating system, your access times, and the pages you have viewed directly before and after accessing the site.", "Thông tin mà máy chủ của chúng tôi tự động thu thập khi bạn truy cập trang web, như địa chỉ IP, loại trình duyệt, hệ điều hành, thời gian truy cập và các trang bạn đã xem ngay trước và sau khi truy cập trang web."),
    ("Financial Data", "Dữ liệu tài chính"),
    ("Financial information, such as data related to your payment method (e.g., valid credit card number, card brand, expiration date) that we may collect when you purchase, order, return, exchange, or request information about our services from the site.", "Thông tin tài chính, như dữ liệu liên quan đến phương thức thanh toán của bạn (ví dụ: số thẻ tín dụng hợp lệ, loại thẻ, ngày hết hạn) mà chúng tôi có thể thu thập khi bạn mua, đặt hàng, hoàn trả, trao đổi hoặc yêu cầu thông tin về các dịch vụ của chúng tôi từ trang web."),
    ("Use of Your Information", "Sử dụng thông tin của bạn"),
    ("Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. Specifically, we may use information collected about you via the site to:", "Có thông tin chính xác về bạn cho phép chúng tôi cung cấp cho bạn một trải nghiệm suôn sẻ, hiệu quả và được cá nhân hóa. Cụ thể, chúng tôi có thể sử dụng thông tin thu thập được qua trang web để:"),
    ("Create and manage your account.", "Tạo và quản lý tài khoản của bạn."),
    ("Process your transactions and send you related information, including purchase confirmations and invoices.", "Xử lý các giao dịch và gửi cho bạn thông tin liên quan, bao gồm xác nhận mua hàng và hóa đơn."),
    ("Personalize your experience and provide advertisements, content, or features that match your profile and interests.", "Cá nhân hóa trải nghiệm của bạn và cung cấp quảng cáo, nội dung hoặc tính năng phù hợp với hồ sơ và sở thích của bạn."),
    ("Improve the site, services, and user experience.", "Cải thiện trang web, dịch vụ và trải nghiệm người dùng."),
    ("Communicate with you, including sending you updates and promotional materials.", "Liên hệ với bạn, bao gồm việc gửi các thông tin cập nhật và tài liệu quảng cáo."),
    ("Disclosure of Your Information", "Tiết lộ thông tin của bạn"),
    ("We may share information we have collected about you in certain situations. Your information may be disclosed as follows:", "Chúng tôi có thể chia sẻ thông tin đã thu thập về bạn trong một số trường hợp nhất định. Thông tin của bạn có thể được tiết lộ như sau:"),
    ("By Law or to Protect Rights", "Theo luật pháp hoặc để bảo vệ quyền lợi"),
    ("If we believe the release of information about you is necessary to respond to legal process, to investigate or remedy potential violations of our policies, or to protect the rights, property, and safety of others, we may share your information as permitted or required by any applicable law, rule, or regulation.", "Nếu chúng tôi tin rằng việc công bố thông tin về bạn là cần thiết để phản hồi các quy trình pháp lý, để điều tra hoặc khắc phục các vi phạm tiềm ẩn đối với chính sách của chúng tôi, hoặc để bảo vệ quyền lợi, tài sản và sự an toàn của người khác, chúng tôi có thể chia sẻ thông tin của bạn theo luật hoặc quy định hiện hành."),
    ("Service Providers", "Nhà cung cấp dịch vụ"),
    ("We may share your information with third-party service providers who perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance.", "Chúng tôi có thể chia sẻ thông tin của bạn với các nhà cung cấp dịch vụ bên thứ ba thực hiện các dịch vụ cho chúng tôi hoặc thay mặt chúng tôi, bao gồm xử lý thanh toán, phân tích dữ liệu, gửi email, dịch vụ lưu trữ, dịch vụ khách hàng và hỗ trợ tiếp thị."),
    ("Security of Your Information", "Bảo mật thông tin của bạn"),
    ("We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.", "Chúng tôi sử dụng các biện pháp bảo mật hành chính, kỹ thuật và vật lý để giúp bảo vệ thông tin cá nhân của bạn. Mặc dù chúng tôi đã thực hiện các bước hợp lý để bảo mật thông tin cá nhân bạn cung cấp, xin lưu ý rằng bất chấp nỗ lực của chúng tôi, không có biện pháp bảo mật nào là hoàn hảo hoặc không thể xâm phạm, và không có phương thức truyền dữ liệu nào có thể được đảm bảo chống lại mọi hành vi đánh chặn hoặc lạm dụng."),
    ("Policy for Children", "Chính sách đối với trẻ em"),
    ("We do not knowingly solicit information from or market to children under the age of 13. If we learn that we have collected personal information from a child under age 13 without verification of parental consent, we will delete that information as quickly as possible.", "Chúng tôi không cố ý thu thập thông tin từ hoặc tiếp thị cho trẻ em dưới 13 tuổi. Nếu chúng tôi biết rằng đã thu thập thông tin cá nhân từ trẻ em dưới 13 tuổi mà không có sự xác nhận đồng ý của cha mẹ, chúng tôi sẽ xóa thông tin đó nhanh nhất có thể."),
    ("Changes to This Privacy Policy", "Thay đổi đối với Chính sách bảo mật này"),
    ("We may update this Privacy Policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal, or regulatory reasons. We will notify you of any changes by posting the new Privacy Policy on this page.", "Chúng tôi có thể cập nhật Chính sách bảo mật này theo thời gian để phản ánh các thay đổi trong thực tế hoạt động của chúng tôi, hoặc vì lý do vận hành, pháp lý hoặc quản lý khác. Chúng tôi sẽ thông báo cho bạn về bất kỳ thay đổi nào bằng cách đăng Chính sách bảo mật mới trên trang này."),
    ("If you have questions or comments about this Privacy Policy, please", "Nếu bạn có câu hỏi hoặc nhận xét về Chính sách bảo mật này, vui lòng"),
    ("contact us", "liên hệ với chúng tôi"),

    ("Terms & Conditions", "Điều khoản & Điều kiện"),
    ("Welcome to Ke Go Eco Lodge, a boutique hotel nestled in the vùng núi Hà Tĩnh. By accessing our website and booking a stay with us, you agree to comply with and be bound by the following terms and conditions. Please read them carefully before making a reservation.", "Chào mừng bạn đến với Ke Go Eco Lodge, khu nghỉ dưỡng sinh thái boutique tọa lạc giữa vùng núi hồ Kẻ Gỗ, Hà Tĩnh. Bằng cách truy cập trang web và đặt phòng với chúng tôi, bạn đồng ý tuân thủ và chịu sự ràng buộc của các điều khoản và điều kiện sau. Vui lòng đọc kỹ trước khi thực hiện đặt phòng."),
    ("2. Booking and Payment", "2. Đặt phòng và Thanh toán"),
    ("Reservations can be made through our website, by phone, or via email. All bookings are subject to availability and confirmation.", "Việc đặt phòng có thể thực hiện thông qua trang web, điện thoại hoặc email. Tất cả các yêu cầu đặt phòng đều tùy thuộc vào tình trạng phòng trống và sự xác nhận của chúng tôi."),
    ("A deposit of 30% of the total booking cost is required to secure your reservation. The balance is due upon check-in. We accept major credit cards, bank transfers, and cash payments.", "Yêu cầu đặt cọc 30% tổng chi phí đặt phòng để đảm bảo giữ chỗ của bạn. Số tiền còn lại sẽ thanh toán khi nhận phòng. Chúng tôi chấp nhận các loại thẻ tín dụng phổ biến, chuyển khoản ngân hàng và tiền mặt."),
    ("3. Cancellation Policy", "3. Chính sách Hủy phòng"),
    ("Cancellations made more than 30 days before the check-in date will receive a full refund.", "Yêu cầu hủy phòng được thực hiện trước ngày nhận phòng hơn 30 ngày sẽ được hoàn trả toàn bộ tiền đặt cọc."),
    ("Cancellations made between 15 and 30 days before the check-in date will incur a 50% charge of the total booking cost.", "Yêu cầu hủy phòng được thực hiện từ 15 đến 30 ngày trước ngày nhận phòng sẽ chịu phí 50% tổng chi phí đặt phòng."),
    ("Cancellations made less than 15 days before the check-in date will be charged the full booking cost.", "Yêu cầu hủy phòng được thực hiện dưới 15 ngày trước ngày nhận phòng sẽ tính 100% tổng chi phí đặt phòng."),
    ("3.2 No-Show", "3.2 Vắng mặt (No-Show)"),
    ("Guests who do not arrive without prior notification will be charged the full booking cost.", "Khách hàng không đến nhận phòng mà không có thông báo trước sẽ bị tính phí toàn bộ chi phí đặt phòng."),
    ("4. Check-In and Check-Out", "4. Nhận phòng và Trả phòng"),
    ("4.1 Check-In", "4.1 Nhận phòng"),
    ("Check-in is available from 3:00 PM. Early check-in is subject to availability and may incur additional charges.", "Thời gian nhận phòng là từ 15:00. Nhận phòng sớm tùy thuộc vào tình trạng phòng trống và có thể tính thêm phí."),
    ("4.2 Check-Out", "4.2 Trả phòng"),
    ("Check-out is by 11:00 AM. Late check-out may be available upon request and may incur additional charges.", "Thời gian trả phòng là trước 11:00. Trả phòng muộn có thể được hỗ trợ theo yêu cầu và có thể tính thêm phí."),
    ("5. Guest Responsibilities", "5. Trách nhiệm của Khách hàng"),
    ("Guests are expected to behave responsibly and respect the property, staff, and other guests. Any damage caused by guests will be charged accordingly.", "Khách hàng cần cư xử có trách nhiệm, tôn trọng tài sản, nhân viên và các khách hàng khác. Mọi hư hại do khách hàng gây ra sẽ bị tính phí tương ứng."),
    ("Guests must comply with all safety regulations and instructions provided by the hotel.", "Khách hàng phải tuân thủ tất cả các quy định an toàn và hướng dẫn do khu nghỉ cung cấp."),
    ("Ke Go Eco Lodge is not liable for any loss, damage, or theft of personal belongings. We recommend that guests take out appropriate travel insurance.", "Ke Go Eco Lodge không chịu trách nhiệm đối với bất kỳ mất mát, hư hỏng hoặc mất cắp tài sản cá nhân nào. Chúng tôi khuyến nghị khách hàng nên mua bảo hiểm du lịch phù hợp."),
    ("We are committed to protecting your privacy. Any personal information provided during the booking process will be used in accordance with our Privacy Policy.", "Chúng tôi cam kết bảo vệ quyền riêng tư của bạn. Mọi thông tin cá nhân cung cấp trong quá trình đặt phòng sẽ được sử dụng theo Chính sách bảo mật của chúng tôi."),
    ("8. Amendments to Terms", "8. Thay đổi Điều khoản"),
    ("Ke Go Eco Lodge reserves the right to amend these terms and conditions at any time. Any changes will be posted on our website and will take effect immediately.", "Ke Go Eco Lodge bảo lưu quyền sửa đổi các điều khoản và điều kiện này bất kỳ lúc nào. Mọi thay đổi sẽ được đăng tải trên trang web của chúng tôi và có hiệu lực ngay lập tức."),
    ("9. Governing Law", "9. Luật áp dụng"),
    ("If you have any questions about our Terms & Conditions, please", "Nếu bạn có bất kỳ câu hỏi nào về Điều khoản & Điều kiện của chúng tôi, vui lòng"),
    
    # Page Title Tag translations
    ("Ke Go Eco Lodge - Area", "Ke Go Eco Lodge - Khu vực"),
    ("Ke Go Eco Lodge - Events", "Ke Go Eco Lodge - Sự kiện"),
    ("Ke Go Eco Lodge - Privacy", "Ke Go Eco Lodge - Chính sách bảo mật"),
    ("Ke Go Eco Lodge - Terms", "Ke Go Eco Lodge - Điều khoản"),
    ("Ke Go Eco Lodge - Licensing", "Ke Go Eco Lodge - Giấy phép bản quyền"),

    # Partially-replaced Privacy Policy main paragraph correction
    ("Welcome to Ke Go Eco Lodge! Your privacy is important to us. This Chính sách bảo mật explains how we collect, use, disclose, and safeguard your information when you visit our website, www.website.com. Please read this policy carefully. If you do not agree with the terms of this Chính sách bảo mật, please do not access the site.", "Chào mừng bạn đến với Ke Go Eco Lodge! Quyền riêng tư của bạn rất quan trọng đối với chúng tôi. Chính sách bảo mật này giải thích cách chúng tôi thu thập, sử dụng, tiết lộ và bảo vệ thông tin của bạn khi bạn truy cập trang web www.website.com. Vui lòng đọc kỹ chính sách này. Nếu bạn không đồng ý với các điều khoản của Chính sách bảo mật này, vui lòng không truy cập trang web."),

    # Wine Tasting case variance
    ("Wine Tasting", "Nếm thử rượu vang"),

    # Terms & Conditions HTML entity & plain variants
    ("Terms &amp; Conditions", "Điều khoản & Điều kiện"),
    ("If you have any questions about our Terms &amp; Conditions, please", "Nếu bạn có bất kỳ câu hỏi nào về Điều khoản & Điều kiện của chúng tôi, vui lòng"),

    # Decorative header HTML entity variants
    ("&amp;STYLE", "&amp; PHONG CÁCH"),
    ("&amp;HAPPENINGS", "&amp; TRẢI NGHIỆM"),
    ("&amp;SEIGHTS", "&amp; CẢNH QUAN"),
]
